...
public class WifiCalculations {
    ...
    public void classifyConsumption() {
        ...
        if (percentage < 80) {
            ...
            recommendation =
                    "El servicio de internet es estable.";
            ...
            recommendation =
                    "Mantener habitos actuales de uso.";

            alert =
                    "Uso dentro del rango normal.";
            ...
            recommendation =
                    "Revisar el plan contratado y la cantidad de dispositivos conectados.";

            alert =
                    "ALERTA: uso elevado del servicio de internet.";
